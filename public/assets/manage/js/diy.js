(function() {
    ...
    defaultData = {
        ...
        banner: {
            ...
            data: [{
                imgUrl: BASE_URL + 'assets/manage/img/diy/banner_01.jpg',
                linkUrl: '',
                advise: '建议尺寸750x360'
            },
            {
                imgUrl: BASE_URL + 'assets/manage/img/diy/banner_02.jpg',
                linkUrl: '',
                advise: '建议尺寸750x360'
            }]
        },
        ...
        navBar: {
            ...
            data: [{
                imgUrl: BASE_URL + 'assets/manage/img/diy/navbar/icon-1.png',
                imgName: 'icon-1.png',
                linkUrl: '',
                text: '按钮文字1',
                color: '#666666',
            ...
            {
                imgUrl: BASE_URL + 'assets/manage/img/diy/navbar/icon-2.png',
                imgName: 'icon-2.jpg',
                linkUrl: '',
                text: '按钮文字2',
                color: '#666666',
            ...
            {
                imgUrl: BASE_URL + 'assets/manage/img/diy/navbar/icon-3.png',
                imgName: 'icon-3.jpg',
                linkUrl: '',
                text: '按钮文字3',
                color: '#666666',
            ...
            {
                imgUrl: BASE_URL + 'assets/manage/img/diy/navbar/icon-4.png',
                imgName: 'icon-4.jpg',
                linkUrl: '',
                text: '按钮文字4',
                color: '#666666',
        ...
        video: {
            ...
            params: {
                ...
                poster: BASE_URL + 'assets/manage/img/diy/video_poster.jpg'
            },
            style: {
                paddingTop: '0',
				height:'180',
        ...
        notice: {
            ...
            params: {
                text: '这里是第一条自定义公告的标题',
                icon: BASE_URL + 'assets/manage/img/diy/notice.png'
            },
            style: {
                paddingTop: '4',
                background: '#ffffff',
        ...
        window: {
            ...
            data: [{
                imgUrl: BASE_URL + 'assets/manage/img/diy/window/01.jpg',
                linkUrl: ''
            },
            {
                imgUrl: BASE_URL + 'assets/manage/img/diy/window/02.jpg',
                linkUrl: ''
            },
            {
                imgUrl: BASE_URL + 'assets/manage/img/diy/window/03.jpg',
                linkUrl: ''
            },
            {
                imgUrl: BASE_URL + 'assets/manage/img/diy/window/04.jpg',
                linkUrl: ''
            }],
            dataNum: 4
        },
        goods: {
            ...
            defaultData: [{
                name: '此处显示商品名称',
                image: BASE_URL + 'assets/manage/img/diy/goods/01.jpg',
                goods_price: '99.00'
            },
            {
                name: '此处显示商品名称',
                image: BASE_URL + 'assets/manage/img/diy/goods/02.jpg',
                goods_price: '99.00'
            },
            {
                name: '此处显示商品名称',
                image: BASE_URL + 'assets/manage/img/diy/goods/03.jpg',
                goods_price: '99.00'
            },
            {
                name: '此处显示商品名称',
                image: BASE_URL + 'assets/manage/img/diy/goods/04.jpg',
                goods_price: '99.00'
            }],
            // 手动选择: 默认数据
            data: [{
        ...
        assemble: {
            ...
            params: {
                ...
                textAlign: 'eight',
                background: '#f3f3f3',
                backgroundimg: BASE_URL + 'assets/manage/img/diy/goods/01.jpg',
                auto: {
                    category: 0,
                    goodsSort: 'all',
                    // all; sales; price
        ...
        signin: {
            ...
            style: {
                background: '#f3f3f3',
                backgroundimage: BASE_URL + 'assets/manage/img/diy/window/01.jpg',
                display: 'list',
                // list; slide
                column: '2',
            },
