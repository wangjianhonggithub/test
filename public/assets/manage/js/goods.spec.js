//先执行规格
	...
	function spec(type){
		...
		$.ajax({
			...
			url:"/index.php?s=/manage/item/specSelect",
	...
	function ajaxGetSpecInput(){
		...
		$(".layui-btn-danger").each(function(){
		...
		$.ajax({
			...
			url:"/index.php?s=/manage/item/getspecInput",
			success:function(data){ 
	...
	function layerbtn(obj){
	  ...
	  if($(obj).hasClass('layui-btn-danger')){
	...
	function goodstype(goods_id,spec_type){
		$.ajax({
			...
			url:"/index.php?s=/manage/item/GetAttrInput",
			success:function(data){
				var datas=data['data'];
