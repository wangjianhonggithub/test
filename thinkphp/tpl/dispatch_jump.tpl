...
<head>
    ...
    <style type="text/css">
        *{ padding: 0; margin: 0; }
		html {background:url(/assets/manage/img/bady-bj.jpg) no-repeat;  background-size:cover;}
...
<body >
    <div class="system-message">
        <?php switch ($code) {?>
            <?php case 1:?>
            <h1><img src="/assets/manage/img/dui.svg"/></h1>
            <p class="success"><?php echo(strip_tags($msg));?></p>
            <?php break;?>
            <?php case 0:?>
            <h1><img src="/assets/manage/img/gan.svg"/></h1>
