...
class Coupon extends BaseModel
{
	...
	public function info(){
		return $this->hasMany('user_coupon','coupon_id','coupon_id')->where('is_use=1');
	}
    /**
     * 优惠券状态 (是否可领取)
     * @param $value
    ...
    public function getList($user = false, $limit = null, $only_receive = false)
    {
        ...
        // 优惠券列表
        $couponList = $this->order(['sort' => 'asc', 'create_time' => 'desc'])->limit($limit)->paginate(15, false, [
    ...
    public function edit($data)
    {
		...
		$data['coupon_id'] ? $where['coupon_id']=$data['coupon_id'] : $where=[];
