...
use app\common\model\AppNavbar;
/**
 * 微信小程序模型
 * Class App
...
class App extends BaseModel
{
 ...
 /**
    ...
    public function edit($data)
    {
	    ...
	    (new AppNavbar)->allowField(true)->save($data,$where);
    ...
    {
        $model = new static;
		if (!$data=Cache::get('app_' . self::$app_id)) {
			$data = $model->with('file')->get($app_id);
            Cache::set('app_' . self::$app_id,$data);
		}
        return $data;
    }
    /**
