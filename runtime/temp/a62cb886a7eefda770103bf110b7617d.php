<?php /*a:2:{s:79:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\user\packslist.html";i:1572591386;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="layui-row">
        ...
        <div class="layui-col-md12 layui-col-xs12 widget-body ">
            <div class="layui-form-item layui-col-md1">
                ...
                <!-- <br><br><div class="layui-col-md1"><a class="layui-btn" href="<?php echo url('courserun'); ?>">新增</a></div> -->
            </div>
            ...
            <form class="layui-form layui-col-md11" method="post" action="">
                ...
                <!-- <div class="layui-form-item">
                    <div class="layui-input-block">
                        <a class="layui-btn layui-btn-primary" href="<?php echo url('index'); ?>">返回列表</a>
                    </div>
                </div> -->
            </form>
                    ...
                    <tbody>
                        ...
                        <?php else: foreach($data['list'] as $value): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($value['tothour']); ?>/<?php echo htmlentities($value['hashour']); ?></td>
...
<script>
    ...
    function getloglist(id) {
        ...
        $.post("<?php echo url('packsloglist'); ?>", { id: id }, function (data) {
            if (data == '400') {
                layer.msg('暂无记录');
            } else {
                layer.open({
