<?php /*a:2:{s:84:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\distribution\detail.html";i:1573785642;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
            ...
            <form id="myforms" class="layui-form" method="post">
                ...
                <div class="widget-body layui-col-lg12">
                    ...
                    <input type="hidden" name="is_grade" value="<?php echo htmlentities($comm['is_grade']); ?>">
                    <div class="layui-form-item">
                        <label class="layui-form-label  ">成为分销商时间 </label>
                        <div class="layui-col-sm5 layer-midd-left">
                            <?php echo date("Y-m-d H:i:s",$comm['become_time']); ?>
                        </div>
                        <div class="layui-form-mid layui-word-aux"></div>
                    </div>
...
<script>
    $(function () {
        ...
        $('#mysubmits').click(function(){
            ...
            $.ajax({
                type: 'POST',
                url:"<?php echo url('distribution/detail'); ?>",
                data:formData,
                contentType: false,
                processData: false,
                dataType: 'json',
