<?php /*a:2:{s:81:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\course\classlist.html";i:1572251362;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <form class="layui-form" method="post" action="<?php echo url('index'); ?>">
                <div class="layui-u-sm-12 layui-u-md-12 layui-col-lg12">
                    <div class="layui-form-item ">
                        <!-- <div class="layui-col-md1"><a class="layui-btn" href="<?php echo url('classrun'); ?>">新增</a></div> -->
                    </div>
                </div>
            </form>
                    ...
                    <tbody>
                        ...
                        <?php else: foreach($data['list'] as $value): ?>
                                <tr>
                                    ...
                                    <td>
                                        <input class="layui-input" type="number" value="<?php echo htmlentities($value['sort']); ?>" onblur="return changesort('<?php echo url('classsort'); ?>',this.value,'<?php echo htmlentities($value['id']); ?>');">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="tpl-table-black-operation">
                                            <a class="tpl-table-black-operation" href="<?php echo url('classrun',['id' => $value['id']]); ?>">编辑</a>
...
<script>
    $(function () {
        // 删除
        $('.delcomm').delete('id', "<?php echo url('classdel'); ?>", '数据删除后无法恢复,确认删除？');
        $('.ishowcomm').delete('id', "<?php echo url('classshow'); ?>", '确认操作？');
    });
</script>
    </div>
    <!-- 内容区域 end -->
