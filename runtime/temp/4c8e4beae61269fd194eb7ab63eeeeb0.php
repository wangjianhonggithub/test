<?php /*a:2:{s:77:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\user\signlog.html";i:1573798059;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="layui-row">
        <div class="layui-col-md12 layui-col-xs12">
            <div class="widget-head">
                <div class="widget-title">签到记录</div>
            </div>
        </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline layui-col-md4">
                        ...
                        <div class="layui-input-inline" >
                            <input name="uid" type="text" class="layui-input" placeholder="搜索用户手机号" value="<?php echo htmlentities($para['uid']); ?>">
                        </div>
                    </div>
                    <div class="layui-input-block">
                        <button class="layui-btn" lay-submit lay-filter="formDemo">查询</button>

                        <a class="layui-btn layui-btn-primary" href="<?php echo url('signlog'); ?>">重置</a>
