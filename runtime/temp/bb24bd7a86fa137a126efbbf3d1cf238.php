<?php /*a:2:{s:81:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\course\coachlist.html";i:1571896519;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="layui-row">
        <div class="layui-col-md12 layui-col-xs12">
            <div class="widget-head">
                <div class="widget-title">教练列表</div>
            </div>
        </div>
            ...
            <form class="layui-form" method="post" action="<?php echo url('index'); ?>">
                <div class="layui-u-sm-12 layui-u-md-12 layui-col-lg12">
                    <div class="layui-form-item ">
                        <div class="layui-col-md1"><a class="layui-btn" href="<?php echo url('coachrun'); ?>">新增</a></div>
                    </div>
                </div>
            </form>
                    ...
                    <tbody>
                        ...
                        <?php else: foreach($data['list'] as $value): ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo htmlentities($value['headpath']); ?>" title="点击查看大图" target="_blank"><img src="<?php echo htmlentities($value['headpath']); ?>" width="60" height="60" alt=""></a></td>
                                    <td><?php echo htmlentities($value['name']); ?></td>
                                    
                                    <td><?php echo date("Y-m-d H:i",$value['modstamp']); ?></td>
                                    <td>
                                        <div class="tpl-table-black-operation">
                                            <a class="tpl-table-black-operation" href="<?php echo url('coachrun',['id' => $value['id']]); ?>">编辑</a>
...
<script>
    $(function () {
        // 删除
        $('.delcomm').delete('id', "<?php echo url('coachdel'); ?>", '数据删除后无法恢复,确认删除？');
    });
</script>
    </div>
    <!-- 内容区域 end -->
