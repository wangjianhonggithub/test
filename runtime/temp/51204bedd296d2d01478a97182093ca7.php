<?php /*a:2:{s:87:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\distribution\user_list.html";i:1573703331;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="layui-col-md12 layui-col-xs12 widget-body">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline layui-col-md4">
                            ...
                            <div class="layui-input-inline">
                                <input name="nickname" type="text" class="layui-input" placeholder="请输入微信昵称" value="<?php echo htmlentities($para['nickname']); ?>">
                            </div>
                        </div>
                        <div class="layui-inline layui-col-md4">
                            ...
                            <div class="layui-input-inline">
                                <select class="layui-inline " lay-search name="level" data-layer-selected="{btnSize: 'sm', placeholder: '注册赠送'}">
                                    <option value="0" <?php if(($para["level"]==0)): ?>selected<?php endif; ?>>全部 </option>
                                    <?php foreach($level as $v): ?>
                                    <option value="<?php echo htmlentities($v['id']); ?>" <?php if(($para["level"]==$v['id'])): ?>selected<?php endif; ?>><?php echo htmlentities($v['level_name']); ?> </option>
                        ...
                        <div class="layui-inline">
                            ...
                            <a class="layui-btn layui-btn-primary" href="<?php echo url('distributor_list'); ?>">重置</a>
                        </div>
                ...
                <div class="layui-col-md12" >
                    <table width="100%" class="layui-table">
                        ...
                        <tr>
                            <td><?php echo htmlentities($item['uid']); ?></td>
                            <td><?php echo htmlentities($item['nickname']); ?></td>
                            <td><?php echo htmlentities($item['directly_online']); ?></td>
                            <td><?php echo htmlentities($item['level_name']); ?></td>
                            <td><?php echo htmlentities($item['commission']); ?></td>
                            <td><?php echo htmlentities($item['user']); ?></td>
                            <td><?php echo htmlentities($item['user1']); ?></td>
                            <td><?php echo htmlentities($item['user2']); ?></td>
                            <td><?php echo htmlentities($item['user3']); ?></td>

                            <td><?php echo date("Y-m-d H:i:s",$item['become_time']); ?></td>
                            <td>
                                <div class="tpl-table-black-operation">
                                    <a href="<?php echo url('detail', ['id' => $item['id']]); ?>">
                                        <i class="layer-icon-pencil"></i> 查看
                                    </a>
                                    <a href="<?php echo url('commission_list', ['uid' => $item['id']]); ?>">
