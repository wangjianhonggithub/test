<?php /*a:2:{s:86:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\market\log\couponlist.html";i:1572253974;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <form class="layui-form layui-col-md11" method="post" action="">
                    ...
                    <div class="layui-inline layui-col-md4">
                        ...
                        <div class="layui-input-inline" >
                            <select class="layui-inline " lay-search name="stype" data-layer-selected="{btnSize: 'sm', placeholder: '类型'}">
                                ...
                                <option value="1" <?php if(($para['stype']==1)): ?>selected<?php endif; ?>>注册领取</option>
                                <option value="3" <?php if(($para['stype']==3)): ?>selected<?php endif; ?>>管理员发放</option>
                                <option value="2" <?php if(($para['stype']==2)): ?>selected<?php endif; ?>>客户使用</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline layui-col-md3">
                        ...
                        <div class="layui-input-inline" >
                            <select class="layui-inline " lay-search name="adminid" data-layer-selected="{btnSize: 'sm', placeholder: '管理员'}">
                                <option value="0" <?php if(($para["adminid"]==0)): ?>selected<?php endif; ?>>全部</option>
                                <?php foreach($adminlist as $val): ?>
                                    <option value="<?php echo htmlentities($val['user_id']); ?>" <?php if(($para['adminid']==$val['user_id'])): ?>selected<?php endif; ?>><?php echo htmlentities($val['user_name']); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <a class="layui-btn layui-btn-primary" href="<?php echo url('couponloglist'); ?>">重置</a>
                    </div>
                </div>
            </form>
                    ...
                    <tbody>
                        ...
                        <?php else: foreach($data['list'] as $value): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($value['content']); ?></td>
                                    <td>
