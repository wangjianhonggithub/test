<?php /*a:2:{s:76:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\sys\funcrun.html";i:1573799732;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="layui-row">
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
            <div class="widget-head">
                <div class="widget-title">功能配置</div>
            </div>
            <form id="myform" class="layui-form" method="post">
                <div class="widget-body layui-col-lg12">
                    <?php foreach($list as $val): ?>
                        <div class="layui-form-item">
                            <label class="layui-form-label form-require"><?php echo htmlentities($val['name']); ?></label>
                            <div class="layui-col-sm5 layer-midd-left">
                                <input type="radio" name="<?php echo htmlentities($val['key']); ?>" value="1" title="开启" <?php if(($val['isopen']==1)): ?>checked<?php else: ?><?php endif; ?>>　　 <input type="radio" name="<?php echo htmlentities($val['key']); ?>" value="2" title="关闭" <?php if(($val['isopen']==2)): ?>checked<?php else: ?><?php endif; ?>>
                            </div> 
