<?php /*a:2:{s:84:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\market\ad\grouplist.html";i:1572253813;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="layui-row">
        <div class="layui-col-md12 layui-col-xs12">
            <div class="widget-head">
                <div class="widget-title">广告分组列表</div>
            </div>
        </div>
        <div class="layui-col-md12 layui-col-xs12 widget-body ">
            <div class="layui-form-item layui-col-md1"><div class="layui-col-md1"><a class="layui-btn" href="<?php echo url('adgrouprun'); ?>">新增</a></div></div>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline layui-col-md4">
                        ...
                        <div class="layui-input-inline">
                            <input name="name" type="text" class="layui-input" placeholder="请输入分组名称" value="<?php echo htmlentities($para['name']); ?>">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        ...
                        <a class="layui-btn layui-btn-primary" href="<?php echo url('adgrouplist'); ?>">重置</a>
                    </div>
                </div>
            </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tpl-table-black-operation">
                                            <a class="tpl-table-black-operation" href="<?php echo url('adgrouprun',['id' => $value['id']]); ?>">编辑</a>
...
<script>
    $(function () {
        // 删除
        $('.delcomm').delete('id', "<?php echo url('adgroupdel'); ?>", '数据删除后无法恢复,确认删除？');
    });
</script>
    </div>
    <!-- 内容区域 end -->
