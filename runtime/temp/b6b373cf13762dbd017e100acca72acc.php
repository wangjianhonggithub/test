<?php /*a:2:{s:88:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\market\flash_sale\index.html";i:1573436591;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="layer-g tpl-g">
    ...
    <div class="layui-row">
        ...
        <div class="layui-col-md12 layui-col-xs12 widget-body ">
            <div class="layui-form-item layui-col-md1"><div class="layui-col-md1"><a class="layui-btn" href="<?php echo url('manage/Market/addflashsale'); ?>">新增活动</a></div></div>
            ...
            <form class="layui-form layui-col-md11" method="post" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline layui-col-md4">
                        ...
                        <div class="layui-input-inline">
                            <input name="title" type="text" class="layui-input" placeholder="请输入活动名称" value="<?php echo htmlentities($para['title']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline layui-col-md4">
                        ...
                        <div class="layui-input-inline">
                            <input name="goods_name" type="text" class="layui-input" placeholder="请输入活动名称" value="<?php echo htmlentities($para['goods_name']); ?>">
                        </div>
                    </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline layui-col-md4">
                        ...
                        <div class="layui-input-inline">
                            <select class="layui-inline " lay-search name="status" data-layer-selected="{btnSize: 'sm', placeholder: '注册赠送'}">
                                <option value="0" <?php if(($para["status"]==0)): ?>selected<?php endif; ?>>全部 </option>
                                <option value="1" <?php if(($para["status"]==1)): ?>selected<?php endif; ?>>未开始 </option>
                                <option value="2" <?php if(($para["status"]==2)): ?>selected<?php endif; ?>>进行中 </option>
                                <option value="3" <?php if(($para["status"]==3)): ?>selected<?php endif; ?>>已结束 </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <a class="layui-btn layui-btn-primary" href="<?php echo url('qbgoods'); ?>">重置</a>
                    </div>
                </div>
            ...
            <div class="layui-col-md12">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlentities($value['goods_name']); ?></td>
                        <td><?php echo htmlentities($value['goods_num']); ?></td>
                        <td>￥<?php echo htmlentities($value['price']); ?></td>
                        <td><?php echo htmlentities($value['buy_limit']); ?></td>
                        <td><?php echo date("Y-m-d H:i:s",$value['startstamp']); ?></td>
                        <td>
                            <?php echo date("Y-m-d H:i:s",$value['endstamp']); ?>
                        </td>
                        <td>
                            <?php echo htmlentities($value['buy_num']); ?>
                        </td>

                        <td>
                            <?php echo htmlentities($value['order_num']); ?>
                        </td>

                        <td>

                            <?php if(time() < $value['startstamp']): ?>未开始
                                <?php elseif(time() <= $value['startstamp']): ?>未开始
                                <?php elseif(time() >= $value['startstamp'] and time() <= $value['endstamp']): ?>进行中
                                <?php elseif(time() > $list['end_time']): ?>已结束
                            <?php endif; ?>
                        </td>
                        <td>
                            <div class="tpl-table-black-operation">

                                <?php if(time() >= $value['startstamp'] and time() <= $value['endstamp']): ?>
                                <a href="javascript:void(0);" class="value-delete tpl-table-black-operation-del endcomm" data-id="<?php echo htmlentities($value['id']); ?>"><i class="mdi menu-icon mdi-pencil-lock"></i> 结束</a>
                                <?php else: ?>
                                <a class="tpl-table-black-operation" href="<?php echo url('addflashsale',['id' => $value['id']]); ?>">编辑</a>
...
<script>
    $(function () {
        // 删除
        $('.delcomm').delete('id', "<?php echo url('flashsaledel'); ?>", '数据删除后无法恢复,确认删除？');
        $('.endcomm').delete('id', "<?php echo url('flashsaleend'); ?>", '确认提前结束该活动？');
        $('.isregetcomm').delete('id', "<?php echo url('couponisreget'); ?>", '确认操作？');
    });
