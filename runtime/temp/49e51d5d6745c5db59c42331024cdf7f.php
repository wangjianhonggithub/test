<?php /*a:2:{s:76:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\index\index.html";i:1572250614;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="layui-col-md12 layui-col-xs12">
            <div class="widget layui-col-md12 widget-bff">
                <div class="widget-head">
                    <div class="widget-title">信息统计</div>
                </div>
                ...
                <div class="widget-body layer-cf ">
                    <div class="layui-col-sm12 layui-col-md6 layui-col-lg3 lay-rouw ">
						<a href="<?php echo url('course/index'); ?>">
							<div class="stat-number">
								<div class="volume vol-blue-left">
									<p>进行中课程</p>
									<h3><?php echo htmlentities($numbers['coursenum']); ?></h3>
								</div>
								<div class="icon-volume vol-blue-right">
									<div style="margin-top: 10%;"><i class="layui-icon" style="font-size: 45px;">&#xe66c;</i></div>
								</div>
							</div>
						</a>
                    </div>
                    ...
                    <div class="layui-col-sm12 layui-col-md6 layui-col-lg3 lay-rouw ">
                     	<a href="<?php echo url('course/index'); ?>">
							<div class="stat-number">
								<div class="volume vol-purple-left">
									<p>历史课程</p>
									<h3><?php echo htmlentities($numbers['coursenum_his']); ?></h3>
								</div>
								<div class="icon-volume vol-purple-right">
									<div style="margin-top: 10%;"><i class="layui-icon" style="font-size: 45px;">&#xe647;</i></div>
								</div>
                    ...
                    <div class="layui-col-sm12 layui-col-md6 layui-col-lg3 lay-rouw ">
                     	<a href="<?php echo url('ordercourse/index'); ?>">
							<div class="stat-number">
								<div class="volume vol-green-left">
									<p>订单总量</p>
									<h3><?php echo htmlentities($numbers['ordernum']); ?></h3>
								</div>
								<div class="icon-volume vol-green-right">
									<div style="margin-top: 10%;"><i class="layui-icon" style="font-size: 45px;">&#xe63c;</i></div>
								</div>
                    ...
                    <div class="layui-col-sm12 layui-col-md6 layui-col-lg3 lay-rouw ">
                   		<a href="<?php echo url('user/index'); ?>">
							<div class="stat-number">
								<div class="volume vol-yellow-left">
									<p>会员总量</p>
									<h3><?php echo htmlentities($numbers['usernum']); ?></h3>
								</div>
								<div class="icon-volume vol-yellow-right">
									<div style="margin-top: 10%;"><i class="layui-icon" style="font-size: 45px;">&#xe770;</i></div>
								</div>
    ...
    <div class="row">
		<div class="layui-col-sm12">
			...
			<div class="layui-col-md12 layui-col-xs12">
				<div class="widget layer-cf  widget-bff">
					<div class="widget-head">
						<div class="widget-title ">服务器信息</div>
					</div>
				
					<table class="layui-table" style='vertical-align: middle;text-align: center; ' width="100%" >
						<tbody>
							<?php foreach($server as $item): ?>
								<tr>
									<td><?= $item['name'] ?></td>
									<td><?= $item['value'] ?>　<?= $item['status'] !== 'normal' ? '('.$item['remark'].')' : '' ?></td>
								</tr>
							<?php endforeach; ?>
						</tbody>
					</table>
			...
			<div class="layui-col-md12 layui-col-xs12">
				<div class="widget layer-cf  widget-bff">
					<div class="widget-head">
						<div class="widget-title ">PHP环境要求</div>
					</div>
				
					<table class="layui-table" style='vertical-align: middle;text-align: center; ' width="100%" >
						<tbody>
							<?php foreach($phpinfo as $item): ?>
								<tr>
									<td><?= $item['name'] ?></td>
									<td><?= $item['value'] ?> </td>
									<td>
										<?php if ($item['status'] !== 'danger'): ?>
											<i style="color: #4db14d !important;" class="layui-icon">&#xe605;</i>
										<?php else: ?>
											<i style="color: #f00 !important;" class="layui-icon">&#x1006;</i>
										<?php endif; ?>

										<?= $item['status'] !== 'normal' ? '('.$item['remark'].')' : '' ?>
									</td>
								</tr>
							<?php endforeach; foreach($writeable as $item): ?>
							<tr>
								<td><?= $item['name'] ?></td>
