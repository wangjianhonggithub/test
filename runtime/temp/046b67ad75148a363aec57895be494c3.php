<?php /*a:2:{s:82:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\market\packs\list.html";i:1572423809;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="layer-g tpl-g">
    ...
    <div class="layui-row">
        ...
        <div class="layui-col-md12 layui-col-xs12 widget-body ">
            <div class="layui-form-item layui-col-md1"><div class="layui-col-md1"><a class="layui-btn" href="<?php echo url('packsrun'); ?>">新增</a></div></div>
            ...
            <form class="layui-form layui-col-md11" method="post" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline layui-col-md4">
                        ...
                        <div class="layui-input-inline">
                            <input name="sid" type="text" class="layui-input" placeholder="请输入课程包编号" value="<?php echo htmlentities($para['sid']); ?>">
                        </div>
                    </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        ...
                        <a class="layui-btn layui-btn-primary" href="<?php echo url('packslist'); ?>">重置</a>
                    </div>
                </div>
            </form>
                    ...
                    <tbody>
                        ...
                        <?php else: foreach($data['list'] as $value): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($value['tothour']); ?></td>
                                    <td><?php echo htmlentities($value['validays']); ?>天</td>
                                    
                                    <td>
                                        <input class="layui-input" type="number" value="<?php echo htmlentities($value['sort']); ?>" onblur="return changesort('<?php echo url('packsort'); ?>',this.value,'<?php echo htmlentities($value['id']); ?>');">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="tpl-table-black-operation">
                                            <a class="tpl-table-black-operation" href="<?php echo url('packsrun',['id' => $value['id']]); ?>">编辑</a>
...
<script>
    $(function () {
        // 删除
        $('.delcomm').delete('id', "<?php echo url('packsdel'); ?>", '数据删除后无法恢复,确认删除？');
        $('.ishowcomm').delete('id', "<?php echo url('packshow'); ?>", '确认操作？');
    });
</script>
    </div>
    <!-- 内容区域 end -->
