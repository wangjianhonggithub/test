<?php /*a:4:{s:74:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\item\edit.html";i:1570756965;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;s:95:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layouts\_template\file_library.html";i:1570787043;s:89:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\item\_template\spec_many.html";i:1569486733;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="layer-g tpl-g">
    ...
    <div class="tpl-content-wrapper <?php if(isset($second['list']) == null): ?>no-sidebar-second<?php endif; ?>">
        <link rel="stylesheet" href="assets/manage/css/goods.css">
							...
							<div class="layui-tab-item layui-show">
								...
								<div class="layer-form-group">
									...
									<div class="layui-col-sm2 layer-midd-left">
										<a href="<?php echo url('item/editcategory'); ?>" class="layui-btn layui-btn-sm">去添加</a>
									</div>
								...
								<div class="layer-form-group">
									...
									<div class="layui-col-sm2  layer-midd-left">
										...
										<div class="layui-col-sm2 layer-midd-left">
											<a href="<?php echo url('item/savebrand'); ?>" class="layui-btn layui-btn-sm">去添加</a>
										</div>
								...
								<div class="layer-form-group">
									...
									<div class="layui-col-sm2  layer-midd-left">
										...
										<div class="layui-col-sm2 layer-midd-left">
											<a href="<?php echo url('setting/edit'); ?>" class="layui-btn layui-btn-sm">去添加</a>
										</div>
								</div>
...
<script id="tpl_spec_attr" type="text/template">
		<div id="goods_spec_table1">                                
			<div class="layui-form-item">
				<div class="layui-col-sm4  layui-form-label"><b>商品规格:</b></div>
			</div>
			{{ each data.list }}
				<div class="layui-form-item">
					<div class="layui-form-label">{{ $value['name'] }}：</div>
					<div class="layui-col-sm7 "> 
						{{ each $value.spec_item as $val  }}
							<button type="button" data-spec_id="{{ $value.id }}" data-item_id="{{ $val['id'] }}" onclick="layerbtn(this)" class="spec_list layui-btn">
							{{ $val['item'] }}
							</button>
						{{ /each }}
					</div>
...
<script src="assets/manage/js/goods.spec.js"></script>
<script>
...
<script>
	$(function () {
		...
		layui.use('layedit', function(){
			...
			height: 600, //设置编辑器高度
			uploadImage: {
					url: '/index.php?s=/manage/upload/upload' //接口url
				, type: 'post' //默认post
				}
			});	
		});
