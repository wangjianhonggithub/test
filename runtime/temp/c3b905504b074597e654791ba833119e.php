<?php /*a:4:{s:80:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\item\brand\save.html";i:1569486733;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;s:96:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layouts\_template\tpl_file_item.html";i:1570786084;s:95:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layouts\_template\file_library.html";i:1570787043;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="layui-col-sm12 layui-col-md12 layui-col-lg12">
			<form id="my-form" class="layui-form " enctype="multipart/form-data" method="post">						
				<div class="widget-head">							
					<div class="widget-title">品牌详情</div>		
				</div>
				<div class="widget-body layui-col-sm12 layui-col-md12 layui-col-lg12">
				   
						<div class="layui-form-item">
							<label class="layui-form-label form-require">品牌名称:</label>
							<div class="layui-col-sm7 layer-midd-left">
								<input type="text" class="layui-input" name="brand[name]"
									   value="<?php echo isset($list['name']) ? htmlentities($list['name']) : ''; ?>" required>
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label form-require">品牌网址:</label>
							<div class="layui-col-sm7 layer-midd-left">
								<input type="text" class="layui-input" name="brand[url]"
									   value="<?php echo isset($list['url']) ? htmlentities($list['url']) : ''; ?>" required>
							</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-col-sm7 layer-midd-left">
								<div class="layer-form-file">
									...
									<div class="uploader-list layer-cf">
										  <div class="file-item">
												<a href="<?php echo htmlentities($list['file_path']); ?>" title="点击查看大图" target="_blank">
													<img src="<?php echo htmlentities($list['file_path']); ?>">
												</a>
												<input type="hidden" name="brand[logo]"
													   value="<?php echo isset($list['logo']) ? htmlentities($list['logo']) : ''; ?>">
						...
						<div class="layui-form-item">
							<label class="layui-form-label form-require">品牌排序 </label>
							<div class="layui-col-sm7 layer-midd-left">
								<input type="number" class="layui-input" name="brand[sort]"
									   value="<?php echo isset($list['sort']) ? htmlentities($list['sort']) : ''; ?>" required>
								<small>数字越小越靠前</small>
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label form-require">品牌描述:</label>
							<div class="layui-col-sm7 layer-midd-left">
							  <textarea rows="4" cols="60" class="layui-textarea" name="brand[desc]">
							  <?php echo htmlentities($list['desc']); ?>
							  </textarea>
							</div>
						</div>
						<div>
