<?php /*a:4:{s:76:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\item\detail.html";i:1570688532;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;s:96:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layouts\_template\tpl_file_item.html";i:1570786084;s:95:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layouts\_template\file_library.html";i:1570787043;}*/ ?>
<!DOCTYPE html>
<html lang="en">
				...
				<div class="widget-body layui-col-sm12 layui-col-md12 layui-col-lg12"> 
					<div class="layui-form-item"> 
						...
						<div class="layui-col-sm7 layer-midd-left"> 
							<label><?php echo htmlentities($model['user']['nickName']); ?></label> 
							<label >(用户id：<?php echo htmlentities($model['user']['user_id']); ?>)</label>
						</div> 
					</div> 
					<div class="layui-form-item"> 
						<label class="layui-form-label">商品图片 </label> 
						<div class="layui-col-sm7 layer-midd-left"> 
						<a href="<?php echo htmlentities($model['order_goods']['image']); ?>" title="点击查看大图" target="_blank"> <img src="<?php echo htmlentities($model['order_goods']['image']); ?>" alt="商品图片" width="80" height="80" /> </a> 
						</div> 
					</div> 
					<div class="layui-form-item"> 
						<label class="layui-form-label">商品名称 </label> 
						<div class="layui-col-sm7 layer-midd-left"> 
					   <?php echo htmlentities($model['order_goods']['name']); ?>
						</div> 
					</div> 
					<div class="layui-form-item"> 
						<label class="layui-form-label">评分</label> 
						<div class="layui-input-block"> 
							<label class="layui-input-inline"> <input type="radio" name="comment[score]" value="10" data-am-ucheck="" <?php echo $model['score']==10 ? 'checked'  :  ''; ?> /> 好评 </label> 
							<label class="layui-input-inline"> <input type="radio" name="comment[score]" value="20" data-am-ucheck="" <?php echo $model['score']==20 ? 'checked'  :  ''; ?> /> 中评 </label> 
							<label class="layui-input-inline"> <input type="radio" name="comment[score]" value="30" data-am-ucheck="" <?php echo $model['score']==30 ? 'checked'  :  ''; ?> /> 差评 </label> 
						</div> 
					</div> 
					<div class="layui-form-item"> 
						<label class="layui-form-label">评价内容 </label> 
						<div class="layui-col-sm7 layer-midd-left"> 
						<textarea class="layer-field-valid layui-textarea" rows="5" placeholder="请输入评价内容" name="comment[content]" required=""><?php echo htmlentities($model['content']); ?></textarea> 
						</div> 
					</div> 
					<div class="layui-form-item"> 
					  <label class="layui-form-label">评价图片 </label> 
						<div class="layui-col-sm7 layer-midd-left"> 
							<div class="layer-form-file"> 
								<button type="button" class="upload-file layui-btn"> <i class="layer-icon-cloud-upload"></i> 选择图片 </button> 
								<div class="uploader-list layer-cf">
								  <?php if(isset($model['image'])): foreach($model['image'] as $key =>$item): ?> 
								 <div class="file-item"> 
									  <a href="<?php echo htmlentities($item['file_path']); ?>" title="点击查看大图" target="_blank">												<img src="<?php echo htmlentities($item['file_path']); ?>">												</a>  
								  <input type="hidden" name="comment[images][]" value="<?php echo htmlentities($item['image_id']); ?>" /> 
					...
					<div class="layui-form-item"> 
						<label class="layui-form-label">评价排序 </label> 
						<div class="layui-col-sm7 layer-midd-left"> 
						<input type="number" min="0" class="layui-input" name="comment[sort]" value="<?php echo htmlentities($model['sort']); ?>" required="" /> 
					   <small>数字越小越靠前</small> 
						</div> 
					</div> 
					<div class="layui-form-item"> 
						...
						<div class="layui-input-block"> 
						<label class="layui-input-inline"> <input type="radio" name="comment[status]" value="1" data-am-ucheck="" <?php echo $model['status']==1 ? 'checked'  :  ''; ?> /> 显示 </label> 
						<label class="layui-input-inline"> <input type="radio" name="comment[status]"  value="0" data-am-ucheck="" <?php echo $model['status']==0 ? 'checked'  :  ''; ?> /> 隐藏 </label> 
						</div> 
					</div> 
					<div class="layui-form-item"> 
						<label class="layui-form-label">评论时间 </label> 
						<div class="layui-col-sm7 layer-midd-left"> 
						<?php echo htmlentities($model['create_time']); ?>
						</div> 
					</div> 
					<div class="layui-input-block"> 
...
<script id="tpl-file-item" type="text/template">
  ...
  <script src="assets/manage/js/ddsort.js"></script><script>
	  $(function () {        // 选择图片       
