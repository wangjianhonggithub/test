<?php /*a:2:{s:83:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\setting\helpcenter.html";i:1573462547;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="layui-row">
        <div class="layui-col-md12 layui-col-xs12">
            <div class="widget-head">
                <div class="widget-title">帮助中心</div>
            </div>
        </div>
        <div class="layui-col-md12 layui-col-xs12 widget-body ">
            <div class="layui-form-item layui-col-md1"><div class="layui-col-md1"><a class="layui-btn" href="<?php echo url('manage/Setting/runanswer'); ?>">新增</a></div></div>
            ...
            <div class="layui-col-md12">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlentities($value['question']); ?></td>
                        <td><?php echo htmlentities($value['sort']); ?></td>

                        <td>
                            <a href="javascript:;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-<?php if($value['is_show'] == 1): ?>normal<?php else: ?>danger<?php endif; ?> ishowcomm " data-id="<?php echo htmlentities($value['id']); ?>"><?php if($value['is_show'] == 1): ?>展示<?php else: ?>隐藏<?php endif; ?></a>
                        </td>

                        <td><?php echo date("Y-m-d H:i:s",$value['addstamp']); ?></td>
                        <td>
                            <?php echo date("Y-m-d H:i:s",$value['modstamp']); ?>
                        </td>

                        <td>
                            <div class="tpl-table-black-operation">

                                <a class="tpl-table-black-operation" href="<?php echo url('runanswer',['id' => $value['id']]); ?>">编辑</a>
...
<script>
    $(function () {
        // 删除
        $('.delcomm').delete('id', "<?php echo url('delanswer'); ?>", '数据删除后无法恢复,确认删除？');
        $('.ishowcomm').delete('id', "<?php echo url('answershow'); ?>", '确认操作？');
