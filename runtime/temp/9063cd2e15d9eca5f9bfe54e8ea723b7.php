<?php /*a:2:{s:83:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\market\coupon\list.html";i:1572940428;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <form class="layui-form layui-col-md11" method="post" action="">
                <div class="layui-form-item">
                    <div class="layui-inline layui-col-md4">
                        ...
                        <div class="layui-input-inline" >
                            <select class="layui-inline " lay-search name="cid" data-layer-selected="{btnSize: 'sm', placeholder: '范围'}">
                                <option value="-1" <?php if(($para["cid"]==-1)): ?>selected<?php endif; ?>>全部</option>
                                ...
                                <?php endforeach; ?>
                                <option value="0" <?php if(($para["cid"]==0)): ?>selected<?php endif; ?>>不限</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="layui-inline layui-col-md4">
                        ...
                        <div class="layui-input-inline">
                            <input name="sid" type="text" class="layui-input" placeholder="请输入优惠券编号" value="<?php echo htmlentities($para['sid']); ?>">
                        </div>
                    </div>
                    <div class="layui-inline layui-col-md3">
                        <label class="layui-form-label">优惠券名称：</label>
                        <div class="layui-input-inline">
                            <input name="name" type="text" class="layui-input" placeholder="请输入优惠券名称" value="<?php echo htmlentities($para['name']); ?>">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline layui-col-md4">
                        ...
                        <div class="layui-input-inline">
                            <select class="layui-inline " lay-search name="isreget" data-layer-selected="{btnSize: 'sm', placeholder: '注册赠送'}">
                                <option value="0" <?php if(($para["isreget"]==0)): ?>selected<?php endif; ?>>全部 </option> 
                                <option value="2" <?php if(($para["isreget"]==2)): ?>selected<?php endif; ?>>是 </option> 
                                <option value="1" <?php if(($para["isreget"]==1)): ?>selected<?php endif; ?>>否 </option> 
                             </select> 
                        </div> 
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <a class="layui-btn layui-btn-primary" href="<?php echo url('couponlist'); ?>">重置</a>
                    </div>
                </div>
            </form>
                    ...
                    <tbody>
                        ...
                        <?php else: foreach($data['list'] as $value): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if(($value['etype'] == 1)): ?>
                                        时间段内有效
                                        <?php elseif(($value['etype'] == 2)): ?>
                                        领取后有效
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if(($value['etype'] == 1)): ?>
                                            <?php echo date("Y-m-d H:i:s",$value['effectstamp']); ?>~<?php echo date("Y-m-d H:i:s",$value['loseefficacystamp']); elseif(($value['etype'] == 2)): ?>
                                        <?php echo htmlentities($value['validays']); ?>天
                                        <?php endif; ?>
                                    </td>
                                    
                                    <td>
                                        <a href="javascript:;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-<?php if($value['isreget'] == 1): ?>primary<?php else: ?>normal<?php endif; ?> isregetcomm " data-id="<?php echo htmlentities($value['id']); ?>"><?php if($value['isreget'] == 1): ?>否<?php else: ?>是<?php endif; ?></a>
                                    </td>

                                    <td><?php echo date("Y-m-d H:i",$value['modstamp']); ?></td>
                                    <td>
                                        <div class="tpl-table-black-operation">
                                            <a class="tpl-table-black-operation-primary" href="javascript:;" onclick='sendcoupon("<?php echo htmlentities($value['sid']); ?>")'>发放优惠券</a>

                                            <a class="tpl-table-black-operation" href="<?php echo url('couponrun',['id' => $value['id']]); ?>">编辑</a>
...
<script>
    $(function () {
        // 删除
        $('.delcomm').delete('id', "<?php echo url('coupondel'); ?>", '数据删除后无法恢复,确认删除？');
