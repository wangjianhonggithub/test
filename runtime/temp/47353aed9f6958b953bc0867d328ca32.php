<?php /*a:2:{s:80:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\auth\role\index.html";i:1569486733;s:71:"E:\PHPTutorial\WWW\dzcyiranjianshen\application\manage\view\layout.html";i:1572926623;}*/ ?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="widget-body layui-col-sm12 layui-col-md12 layui-col-lg12">
				...
				<div class="page_toolbar">
					<div class="layui-form-item q-groups">
								<a class="layui-btn"
								   href="<?php echo url('auth/editRole'); ?>">
							...
							<tr>
								...
								<td class="layer-text-middle">
									<div class="tpl-table-black-operation">
											...
											<a href="<?= url('auth/editRole', ['role_id' => $item['role_id']]) ?>">
